...
![メイン画面（テーマダーク）](images/tanuki1.jpg){: width="400" }
![サムネ縮小、テーマ変更も出来ます](images/tanuki3.jpg){: width="400" }
![動画向けにサムネグリッドの他価値を横長にも出来ます](images/tanuki2.jpg){: width="400" }
![フォントサイズ変更も可能です。](images/tanuki4.jpg{: width="400" }
